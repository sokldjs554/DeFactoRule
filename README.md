...
> ⚠️ 저장소 이름(`authority-grid`)은 주제 선정 과정에서 다른 후보를 가리키던 이름입니다.
> 최종 선택은 후보 3 `DeFactoRule`이며, 저장소명 정리는 보류 중입니다.
...
| 0 | 문제 정의 · 데이터 전략 · 아키텍처 | ⬜ 대기 |
| 1~11 | 구현 | ⬜ 대기 |

**[→ Phase −1 주제 선정 보고서 전문](docs/01-topic-research.md)**
...
| 트랙 | 코퍼스 | 규모 | 라벨 구조 |
|---|---|---|---|
| **Track A** | 법령해석 회신사례 + 비조치의견서 | 1,560 + 361건 (2015–2019 사례집 기준) | 이진 (해당/미해당, 비조치/조치가능) |
| **Track B** | 혁신금융서비스 지정 + 부가조건 | 실측 예정 | 다중 라벨 + 수치 |
